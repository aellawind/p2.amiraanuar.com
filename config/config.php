...
# What is the name of this app?
	define('APP_NAME', 'Amira_App');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'amiraanuar@g.harvard.edu'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'amiraanuar@g.harvard.edu'); 

# Default DB name for this app
	define('DB_NAME', 'amiraanu_p2_amiraanuar_com'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', '*DQln@yDKAd37Y5o78)!1!KS0rmSO1O06aYm_%iN');
	define('TOKEN_SALT', 'h)x3x*7K*TifOAIUodTdnXOQ70JG2Dfagiz)3MY&');